...
# request - http://localhost:5000/products - with method POST
@app.route('/products', methods=['POST'])
def add_product():
    products.append(request.get_json())
    return '', 201

# request - http://localhost:5000/products/144 - with method PUT
...
# request - http://localhost:5000/products/144 - with method DELETE
